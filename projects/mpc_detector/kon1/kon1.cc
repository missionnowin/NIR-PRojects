...
//22222 Physics list:
	...
	physicsList->SetCutValue(1 * keV, "e+");
	physicsList->SetCutValue(1 * keV, "e-");
	physicsList->SetCutValue(1 * keV, "gamma");
	physicsList->SetCutValue(1 * keV, "proton");
	physicsList->SetDefaultCutValue(1 * keV);
	G4ProductionCutsTable::GetProductionCutsTable()->SetEnergyRange(1 * keV, 100 * keV);
