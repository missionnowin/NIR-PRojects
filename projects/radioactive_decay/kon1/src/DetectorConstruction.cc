...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    //Worls
    world = new World(400*cm, 400*cm, 400*cm, Mat("G4_Galactic"));
    ...
    //Box
    G4Box *solidTgt = new G4Box("solidTgt", 200*cm, 200*cm, 10*cm);
    G4LogicalVolume *logiclTgt = new G4LogicalVolume(solidTgt, Mat("G4_Galactic"), "logiclTgt");
    G4PVPlacement *physilTgt = new G4PVPlacement(rotation, G4ThreeVector(0,0,-100*cm), logiclTgt, "physilTgt", world->getLogic(), false, 0);
