...
void PrepareHistos() {
  ...
  hNoise1 = new TH1F ("hNoise1", "Noise, sector 1", 30, 0., 20.);
  hNoise2 = new TH1F ("hNoise2", "Noise, sector 2", 30, 0., 20.);
  hNoise3 = new TH1F ("hNoise3", "Noise, sector 3", 30, 0., 20.);
  hNoise4 = new TH1F ("hNoise4", "Noise, sector 4", 30, 0., 20.);
...
int ThresholdNew(const char *fName, bool WriteToFile =false, int ITH = 0, int VCASN = 0) {
  float NPix   [25];
  float Thresh [25];
